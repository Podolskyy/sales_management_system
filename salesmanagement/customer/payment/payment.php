...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['payment_method']) && !empty($_POST['payment_method'])) {
        ...
        $status = 'Preparing';  // Or fetch from form or default to 'Preparing'
        $type = 'Online';
        ...
        $stmt->bind_param("idsss", $userId, $totalPrice, $status, $paymentMethod, $type);
        $stmt->execute();
        ...
        // Handle error if payment_method is not provided
